...
class OrganicCell:
    ...
    def __sub__(self, other):
        return f'Cell "{self}" has more cells than cell "{other}"' if other.cells > self.cells \
            else self.cells - other.cells
    ...
    def make_order(self, cells_row):
        return ('*' * cells_row + '\n') * int(self.cells // cells_row) + '*' * int(self.cells % cells_row)


cell1 = OrganicCell(12)
cell2 = OrganicCell(16)
